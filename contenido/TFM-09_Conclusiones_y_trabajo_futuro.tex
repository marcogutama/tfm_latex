...
\textbf{Sugerencia de Mitigación con IA} & 
Componente central para análisis y generación de sugerencias contextuales. & 
No (proporciona información sobre la vulnerabilidad, no sugerencias generadas por IA). & 
No (ofrece correcciones automáticas predefinidas, pero no basadas en IA generativa). \\ \hline
