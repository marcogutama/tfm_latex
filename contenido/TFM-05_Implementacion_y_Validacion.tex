...
\chapter{Implementación y Validación Experimental}
...
\hline
\textbf{Modelo de IA} & \textbf{\begin{tabular}[c]{@{}l@{}}Tiempo de \\
Análisis\end{tabular}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Tamaño de \\
Respuesta \\
(Proxy de \\
Tokens)\end{tabular}}} & \textbf{Análisis} \\
\hline
gemini-2.0-flash-exp:free & 1 min 38 seg & 45.6 KB & Rápido y detallado \\
\hline
deepseek-chat:free & 8 min 13 seg & 24.8 KB & \begin{tabular}[c]{@{}l@{}}Lento y moderadamente \\
detallado\end{tabular} \\
\hline
deepseek-r1-0528:free & 18 min 49 seg & 16.1 KB & Muy lento y conciso \\
\hline
qwen-2.5-coder-32b-instruct:free & 4 min 54 seg & \textbf{49.2 KB} & \textbf{\begin{tabular}[c]{@{}l@{}}Velocidad media, \\
respuesta más extensa\end{tabular}} \\
\hline
\end{tabular}%
